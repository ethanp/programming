"""
This code is teaches a user to read in the files in python.
It finds what proportion of males and females survived, and uses it to make a predictive model.
