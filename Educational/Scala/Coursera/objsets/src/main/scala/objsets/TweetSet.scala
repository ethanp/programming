...
abstract class TweetSet {
   ...
   * and be implemented in the subclasses?
   */
   def union(that: TweetSet): TweetSet // EP: I'm leaving it abstract
   ...
   * and be implemented in the subclasses?
   */
  def mostRetweeted: Tweet // EP: I'm leaving it abstract
   ...
   * and be implemented in the subclasses?
   */
  def descendingByRetweet: TweetList // EP: I'm leaving it abstract
