...
2. Display all tasks due within the next 2 weeks on the user's homepage
3. Update the standard `Interval` form to use the Bootstrap formatting (for now at least)

#### `tasks_controller.show()`

7. Put an **interval form** right there in the page (after updating it)
8. Put a **subtask form** right there in the page
