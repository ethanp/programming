...
1. **`Task.priority` levels**
    ...
    2. `default: 0`
    3. \\(x \in \{-5..5\}\\)
2. **"Sleep Time" interface**
    3. How to implement and remain DRY?
    2. Put it in a `Dashboard` object?
...
1. A simple linechart plotting the average time spent on each of the categories
