...
7. Figure out how to add the **Start/End Timer** button. Using javascript? I have no idea.
8. Add an (optional) attribute `estTimeRemaining` to `Tasks`

### Frontend

1. Put the task-form's datetimepicker in the center
2. Give that same datetimepicker to the interval form
3. List the intervals on a task's page
